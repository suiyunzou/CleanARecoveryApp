...
final class FileBrowserMime {
    ...
    static Kind kindFor(String fileName, boolean directory) {
        return kindFor(null, fileName, directory);
    }

    static Kind kindFor(File file, String fileName, boolean directory) {
        if (directory) {
    ...
    static Kind kindForExtension(String extension) {
    ...
    static RecoveryType recoveryTypeFor(Kind kind) {
        switch (kind) {
            case VIDEO:
    ...
    static String mimeTypeFor(File file, String fileName) {
    ...
    static String displayTypeLabel(Kind kind) {
        switch (kind) {
            case DIRECTORY:
                return "Folder";
            case VIDEO:
