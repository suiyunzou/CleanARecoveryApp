...
final class FileBrowserAdapter extends RecyclerView.Adapter<FileBrowserAdapter.Holder> {
    interface Listener {
    ...
    FileBrowserAdapter(List<FileBrowserActivity.FileEntry> entries, Listener listener) {
